...
public partial class DisplayResults : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlDataAdapter da = new SqlDataAdapter("select username, subject, myans,result from test where subject='" + subject + "' order by myans ASC;", con);
        ...
        else
        {
            ...
            Label2.Text = "No Result to be displayed!";
        }
        }
    }
