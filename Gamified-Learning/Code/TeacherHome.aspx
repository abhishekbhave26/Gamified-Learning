<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherHome.aspx.cs" Inherits="Teacher" %>
        ...
        <ul id="menu">
          ...
          <li class="selected"><a href="TeacherHome.aspx">Home</a></li>
           <li><a href="Questions.aspx">Questions</a></li>
            <li><a href="DisplayResults.aspx">Results</a></li>
        </ul>
      </div>
    </div>
        ...
        <div class="sidebar">
          ...
          <div class="sidebar_item">
            <!-- insert your sidebar items here -->
               ...
               <h2>Welcome: <asp:Label ID="Label1" runat="server" ForeColor="Tomato"></asp:Label></h2>
        ...
        <h1>Welcome to Personalized Education and Evaluation through Gamified Learning</h1>
          ...
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
              <Columns>
                  ...
                  <asp:CommandField ButtonType="Button" HeaderText="Option" SelectText="Delete" ShowSelectButton="True">
